...
const HospitalRecipientContract = require('../../blockchain/build-info/HospitalRecipient.json');
const testcontract  = require ('../../blockchain/build-info/test.json');
